...
exports.APP_GENRE_THEMES = exports.GENRE_THEMES = void 0;
exports.hexToRgb = hexToRgb;
exports.rgbToHex = rgbToHex;
exports.scaleHex = scaleHex;
exports.rgbaFromHex = rgbaFromHex;
exports.isVeryLight = isVeryLight;
exports.mixHex = mixHex;
exports.parchFromBorder = parchFromBorder;
...
function mixHex(base, tint, amount) {
    ...
    return rgbToHex(br * (1 - safeAmount) + tr * safeAmount, bg * (1 - safeAmount) + tg * safeAmount, bb * (1 - safeAmount) + tb * safeAmount);
}
function parchFromBorder(border) {
...
exports.APP_GENRE_THEMES = {
    Rock: exports.GENRE_THEMES.Rock,
    Mainstream: exports.GENRE_THEMES.Mainstream,
    Electronic: exports.GENRE_THEMES.Electronic,
    "Hip-Hop": exports.GENRE_THEMES["Hip-Hop"],
    "Disco/Funk": exports.GENRE_THEMES["Disco/Funk"],
    "Reggae/Dub": exports.GENRE_THEMES["Reggae/Dub"],
    Classical: exports.GENRE_THEMES.Classical,
    Vintage: exports.GENRE_THEMES.Vintage,
};
//# sourceMappingURL=genre-themes.js.map