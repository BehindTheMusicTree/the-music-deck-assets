...
export default function PalettePage() {
  return (
    <div className="px-6 py-10 flex flex-col items-center">
      ...
      <div className="font-mono text-[9px] tracking-[3px] text-muted mb-2">01</div>
      <div className="font-mono text-[9px] tracking-[2px] text-muted mb-4">Base design tokens</div>
      ...
      <p className="font-garamond italic text-muted max-w-[600px] text-center mb-12">
        ...
        <code className="font-mono text-[11px]">:root</code> and used consistently across the UI.
      </p>
          ...
          <div key={name} className="flex items-center gap-4 bg-card border border-ui-border rounded px-4 py-3">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-baseline gap-3 flex-wrap">
                <span className="font-mono text-[11px] text-gold">{name}</span>
