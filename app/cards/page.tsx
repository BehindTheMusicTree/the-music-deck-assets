      ...
      <div className="px-6 py-10 flex flex-col items-center min-h-screen">
        ...
        <div id="catalog" className="w-full max-w-[1200px] mb-14 scroll-mt-28">
          ...
          <p className="font-garamond text-muted leading-[1.6] mb-4 max-w-[800px]">
            Every example card used in this charter, in one place. Click a
            preview to open a full-size zoom (close with the backdrop or Esc).
          </p>
          <div className="rounded-[6px] border border-ui-border bg-[#0f0f14]/35 overflow-x-auto">
            <table className="w-full min-w-[900px] border-collapse text-left">
              ...
              <tbody className="font-garamond text-[15px] text-white/95">
                {CATALOG_ENTRIES.map(
                  ({ rowKey, kind, card, theme, genreName }) => (
                    <tr
                      key={rowKey}
