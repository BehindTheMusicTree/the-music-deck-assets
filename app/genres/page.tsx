      ...
      <div className="px-6 py-10 flex flex-col items-center">
        ...
        <div className="w-full max-w-[860px] mt-6 mb-2.5 border border-ui-border rounded-[6px] bg-white/[0.02] overflow-hidden">
          <div className="px-[18px] pt-4 pb-3">
            <div className="font-mono text-[15px] tracking-[2px] uppercase text-muted mb-1">Colour variations</div>
            <p className="font-garamond italic text-muted text-[16px] leading-[1.45] m-0">
              Each genre spans a spectrum — light to dark — from its poppiest subgenre to its most extreme.
            </p>
          </div>

          {/* Spectrum row: Electronic */}
          <div className="px-[18px] pb-4">
            <div className="font-mono text-[11px] tracking-[2px] text-muted uppercase mb-2 opacity-60">Example — Electronic</div>
            ...
            <div className="flex justify-between mt-1 px-0.5">
              <span className="font-mono text-[10px] text-muted opacity-50 tracking-[1px]">← POP</span>
              <span className="font-mono text-[10px] text-muted opacity-50 tracking-[1px]">HARDCORE →</span>
            </div>
          </div>
          ...
          <div className="px-[18px] py-4">
            <div className="font-mono text-[11px] tracking-[2px] text-muted uppercase mb-3 opacity-60">Cross-genre colour mixing</div>
            <div className="flex items-center gap-3 flex-wrap">
              {/* Metal swatch */}
              <div className="flex flex-col items-center gap-1">
                <div className="w-10 h-10 rounded-[4px]" style={{ background: "#7a0810" }} />
                <span className="font-mono text-[10px] tracking-[1px] text-muted">Metal</span>
              </div>
              <span className="font-mono text-[18px] text-muted opacity-40">+</span>
              {/* Hip-hop swatch */}
              <div className="flex flex-col items-center gap-1">
                <div className="w-10 h-10 rounded-[4px]" style={{ background: "#c8960a" }} />
                <span className="font-mono text-[10px] tracking-[1px] text-muted">Hip-hop</span>
              </div>
              <span className="font-mono text-[18px] text-muted opacity-40">=</span>
              {/* Result swatch */}
              <div className="flex flex-col items-center gap-1">
                <div className="w-10 h-10 rounded-[4px]" style={{ background: "#b84008" }} />
                <span className="font-mono text-[10px] tracking-[1px] text-muted">Nu Metal</span>
              </div>
              <p className="font-garamond italic text-muted text-[15px] leading-[1.5] ml-2 max-w-[340px]">
                Crimson + gold yellow blend into <span style={{ color: "#c85010" }}>amber orange</span> — the hue inherits influence from both parent genres.
              </p>
            </div>
          </div>
        </div>
