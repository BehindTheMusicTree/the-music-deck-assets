      ...
      <div className="min-h-[calc(100vh-56px)] bg-bg px-6 py-12 sm:py-[60px] max-w-4xl mx-auto">
        ...
        <div id="card-attributes" className="mb-8 max-w-[560px]">
          ...
          <p className="font-garamond text-muted leading-normal m-0 mb-3">
            Every playable card surfaces four values on the frame. Battle rules and card text refer to them when
            applying modifiers, checks, and resolution.
          </p>
          <ul className="font-garamond text-muted leading-normal m-0 pl-5 space-y-3">
            <li>
              <span className="text-white">Popularity</span> — Shown as 1-9 award symbols on the stat row (gold,
              platinum, then diamond tiers). It measures how broadly the track lands with an audience and is
              independent of intensity.
              <div className="mt-2 h-9 max-w-[280px] rounded-[4px] border border-ui-border/60 bg-bg px-3 flex items-center gap-2">
                <span className="text-[16px] leading-none">🏆</span>
                <span className="text-[16px] leading-none">🏆</span>
                <span className="text-[16px] leading-none">🏆</span>
                <span className="font-mono text-[10px] text-muted ml-auto">NOTE 9</span>
              </div>
            </li>
            <li>
              <span className="text-white">Intensity</span> — The triangle gauge encodes one of four levels: pop,
              soft, experimental, or hardcore. With a subgenre, intensity follows that subgenre; on a genre-only card
              ...
              <div className="mt-2 h-9 max-w-[280px] rounded-[4px] border border-ui-border/60 bg-bg px-3 flex items-center">
                ...
                >
                  <div
                    ...
                    style={{
                      background: "linear-gradient(90deg, #58b85a 0%, #c9b03f 55%, #c55a44 100%)",
                    }}
                  />
                </div>
            ...
            <li>
              <span className="text-white">Advantage</span> — The matchup strip (green side) names genres this card
              is strong against, each with a colour diamond taken from the genre palette.
              <div className="mt-2 h-9 max-w-[280px] rounded-[4px] border border-ui-border/60 bg-bg px-3 flex items-center gap-2">
            ...
            <li>
              <span className="text-white">Weakness</span> — The same strip (red side) names genres this card is weak
              against, again with matching diamonds.
              <div className="mt-2 h-9 max-w-[280px] rounded-[4px] border border-ui-border/60 bg-bg px-3 flex items-center gap-2">
          ...
          <p className="font-garamond text-muted text-sm leading-normal mt-3 mb-0">
            ...
            <Link href="/genres#associations" className="text-gold underline-offset-2 hover:underline">
              Genres — Associations
            </Link>
            .
          </p>
        ...
        <div id="vibe" className="mb-8 max-w-[560px]">
          ...
          <ul className="font-garamond text-muted leading-normal m-0 pl-5 space-y-1.5">
            <li>
              The score is a single <span className="text-white">Vibe</span> gauge, not a detached number on its own.
            </li>
            <li>
        ...
        <div className="mb-8 max-w-[560px]">
          ...
          <div
            ...
            style={{
              background: "linear-gradient(90deg, var(--gold-hi) 0%, var(--color-surface) 50%, #4058a0 100%)",
            }}
            role="img"
...
function BattlesAudio() {
  ...
  return (
    <div className="min-h-[calc(100vh-56px)] bg-bg px-6 py-12 sm:py-[60px] max-w-4xl mx-auto">
      <div className="page-kicker mb-4">Game</div>
      <h1 className="font-cinzel text-3xl font-bold tracking-[4px] text-white mb-3">Battles — Audio</h1>
      <p className="font-garamond italic text-muted mb-8 max-w-[660px]">
        Battle audio specification for production and runtime only. This section is internal tooling for the game
      ...
      <section className="mb-10 max-w-[760px]">
        ...
        <ul className="font-garamond text-muted leading-normal m-0 pl-5 space-y-1.5">
          ...
          <li>Each generated asset is 3:00 and must avoid plagiarism and celebrity voice imitation.</li>
          <li>Non-battle audio (menus, collection, UI, boosters) is out of scope in this section.</li>
        </ul>
      </section>
      ...
      <section className="mb-10 max-w-[760px]">
        ...
        <ul className="font-garamond text-muted leading-normal m-0 pl-5 space-y-1.5">
          <li>Genre-intensity nodes: Mainstream (pop-only) = 1, plus 7 genres x 4 intensity = 28.</li>
          <li>Countries target: 50.</li>
          <li>Total elements: 79.</li>
          <li>Total 2-element combinations: C(79,2) = 3081.</li>
          <li>Total generated duration: 3081 x 3 min = 9243 min (~154.1 hours).</li>
        </ul>
      </section>
      ...
      <section className="mb-10 max-w-[760px]">
        ...
        <ul className="font-garamond text-muted leading-normal m-0 pl-5 space-y-1.5">
          <li>Active turn decides ownership: your turn plays your active context, opponent turn plays theirs.</li>
          <li>No active card for the current player means silence.</li>
          <li>One active card plays its single track (country or genre-intensity).</li>
          <li>Two active cards play the dedicated 2-element combination track.</li>
          <li>Three or more active cards use the combination of the two most recently activated cards.</li>
          <li>First start from silence begins at 0:00 with no fade-in.</li>
          <li>
            Any transition with an already playing track uses overlap crossfade: fade-out/fade-in both at 3s, with
            the incoming track starting from a random offset between 10s and 120s.
          </li>
          <li>On track ending, self-crossfade at 3s and restart the same track at 0:00.</li>
          <li>
            If crossfade A -&gt; B is in progress and C arrives, cancel B and redirect immediately to A -&gt; C
            (last-write-wins).
          </li>
        </ul>
      </section>
